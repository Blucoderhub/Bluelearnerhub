...
const features = [
  {
    ...
    description: 'Master your field with interactive labs and tutorials across Computer Science, Software Engineering, and IT.',
    icon: BookOpen,
  ...
  },
  {
    ...
    description: 'Connect with a world-class network of software engineers and tech professionals.',
    icon: Users,
    color: 'from-primary to-primary/60',
    bgColor: 'bg-primary/10',
    borderColor: 'group-hover:border-primary/50',
