...
export const tutorialsAPI = {
  ...
  search: (query: string) =>
    api.get('/tutorials/search', { params: { q: query } }).then((r) => r.data),
...
export const quizzesAPI = {
  ...
  adaptiveGuidance: (id: number) => api.get(`/quiz/${id}/adaptive-guidance`).then((r) => r.data),
}
...
export const qnaAPI = {
  listQuestions: (params?: Record<string, string>) =>
    api.get('/qna/questions', { params }).then((r) => r.data),
  searchQuestions: (q: string) =>
    api.get('/qna/questions/search', { params: { q } }).then((r) => r.data),
...
export const gamificationAPI = {
  ...
  leaderboard: (limit?: number) =>
    api
      .get('/gamification/leaderboard', { params: limit ? { limit } : undefined })
      .then((r) => r.data),
}
...
export const codeAPI = {
  execute: (code: string, language: string, stdin?: string) =>
    api.post('/code/execute', { code, language, stdin }).then((r) => r.data),
  languages: () => api.get('/code/languages').then((r) => r.data),
}
