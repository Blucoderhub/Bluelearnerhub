  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ color: '#818cf8', fontSize: '14px', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
        ...
        >
          Learn Coding.{' '}
          <span style={{ color: '#818cf8' }}>Get Hired.</span>
        </div>
        ...
        >
          Free Python, JavaScript, React, System Design & more.
          AI quizzes · Hackathons · Verified Certificates
        </div>
        ...
        <div style={{ display: 'flex', gap: '48px' }}>
          {[
            ...
            <div key={s.label} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '14px', color: 'rgba(255,255,255,0.5)', marginTop: '4px', letterSpacing: '0.1em' }}>{s.label}</span>
            </div>
          ))}
        </div>
