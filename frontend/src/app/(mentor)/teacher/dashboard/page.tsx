...
import {
  BookOpen, Users, TrendingUp, Star, Eye, Clock,
  ChevronRight, Plus, Award, Zap, BarChart3,
...
const MOCK_TUTORIALS = [
  {
    id: 1, title: 'TypeScript Deep Dive: Generics & Utilities',
    domain: 'Software', status: 'published', views: 14_200, students: 892,
    rating: 4.9, completionRate: 78, updatedAt: '2026-03-05',
  },
  {
    id: 2, title: 'React 18 — Concurrent Features & Suspense',
    domain: 'Software', status: 'published', views: 11_800, students: 742,
    rating: 4.8, completionRate: 71, updatedAt: '2026-03-01',
  },
  {
    id: 3, title: 'PostgreSQL Performance Tuning',
    domain: 'Software', status: 'published', views: 8_400, students: 560,
    rating: 4.7, completionRate: 65, updatedAt: '2026-02-22',
  },
  {
    id: 4, title: 'Building ML Pipelines with PyTorch',
    domain: 'AI/ML', status: 'draft', views: 0, students: 0,
    rating: 0, completionRate: 0, updatedAt: '2026-03-09',
  },
];
      ...
      <div className="border-b border-gray-800 bg-gradient-to-b from-gray-900 to-gray-950 px-6 py-8">
        <div className="mx-auto max-w-6xl flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">Track your content performance and student engagement</p>
          </div>
          <Link href="/teacher/studio">
            <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:opacity-90 font-semibold gap-2">
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        >
          {[
            ...
            { label: 'XP Awarded',     value: (MOCK_STATS.xpAwarded / 1000).toFixed(0) + 'K', icon: Zap, color: 'text-emerald-400', change: '+24%', up: true },
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2 text-xs">
                <Badge className="bg-emerald-900/50 text-emerald-400">{MOCK_STATS.publishedCount} published</Badge>
                  ...
                  <Card className="bg-gray-900 border-gray-800 hover:border-gray-700 transition-all">
                    <CardContent className="p-4">
                      <div className="flex items-start gap-4">
                        ...
                        <Link href="/teacher/studio">
                          <Button variant="ghost" size="sm" className="text-xs text-gray-400 hover:text-white shrink-0 gap-1">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                      ...
                      <span className="text-white">{Math.round((MOCK_STATS.publishedCount / MOCK_STATS.totalTutorials) * 100)}%</span>
                    </div>
                    <Progress value={Math.round((MOCK_STATS.publishedCount / MOCK_STATS.totalTutorials) * 100)} className="h-1.5" />
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5">
                ...
                <div className="space-y-3">
                  {MOCK_RECENT_ACTIVITY.map((a, i) => {
                    const { icon: Icon, color } = ACTIVITY_ICONS[a.type as keyof typeof ACTIVITY_ICONS] ?? { icon: Zap, color: 'text-gray-400' };
                    return (
