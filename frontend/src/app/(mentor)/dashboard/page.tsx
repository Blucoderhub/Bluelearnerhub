    ...
    return (
        <div className="space-y-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-black text-white tracking-tight">Welcome back, <span className="text-amber-400">Elite Mentor</span></h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button className="bg-amber-500 hover:bg-amber-600 text-white font-black rounded-xl px-6 shadow-lg shadow-amber-500/20">
                        View Public Page
                    </Button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { label: 'Hours Taught', value: '156h', icon: Clock, color: 'text-amber-400', bg: 'bg-amber-400/10' },
                    ...
                    <Card key={stat.label} className="bg-slate-900/40 border-slate-800/60 rounded-3xl overflow-hidden group">
                        <CardContent className="p-6">
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex items-center gap-1 text-[10px] font-black text-amber-400 uppercase tracking-widest bg-amber-400/10 px-2 py-1 rounded-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="lg:col-span-2 bg-slate-900/40 border-slate-800/60 rounded-[2rem]">
                    <CardHeader className="p-8 border-b border-slate-800/40">
                        <div className="flex items-center justify-between">
                            ...
                            <Button variant="ghost" className="text-amber-400 hover:text-amber-300 font-bold text-xs uppercase">View All</Button>
                        </div>
                    </CardHeader>
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="flex items-center justify-between p-8 border-b border-slate-800/40 last:border-0 hover:bg-slate-800/20 transition-colors">
                                <div className="flex items-center gap-4">
                                    <div className="h-12 w-12 rounded-xl bg-slate-800 flex items-center justify-center font-bold text-amber-400">JD</div>
                                    <div>
                                ...
                                <Button className="bg-slate-800 hover:bg-amber-500 hover:text-white text-slate-300 font-bold rounded-xl h-10 px-6 transition-all">
                                    Grade
                                </Button>
                            </div>
                        ))}
                ...
                <Card className="bg-slate-900/40 border-slate-800/60 rounded-[2rem]">
                    ...
                    <CardContent className="p-8 space-y-6">
                        {[1, 2].map((i) => (
                            <div key={i} className="relative pl-6 border-l-2 border-amber-500/30">
                                <div className="absolute top-0 left-[-5px] w-2 h-2 rounded-full bg-amber-500" />
                                <p className="text-[10px] font-black text-amber-400 uppercase tracking-widest">Tomorrow, 10:00 AM</p>
                                ...
                                <Button className="w-full mt-4 bg-amber-500/10 hover:bg-amber-500 text-amber-400 hover:text-white border border-amber-500/20 font-bold rounded-xl h-9 text-xs transition-all">
                                    Join Zoom
                                </Button>
                            </div>
                        ))}
