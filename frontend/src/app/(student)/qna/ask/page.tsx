...
const DOMAIN_OPTIONS = [
  'computer-science', 'machine-learning', 'mechanical', 'electrical',
  'civil', 'finance', 'management', 'mathematics',
];
      ...
      <div className="mx-auto max-w-3xl px-6 py-8">
        ...
        <div className="mb-8">
          <div className="mb-2 flex items-center gap-2 text-sm text-gray-500">
            <Link href="/qna" className="hover:text-white">Q&A Hub</Link>
            <ChevronRight className="h-3.5 w-3.5" />
            <span>Ask a Question</span>
          </div>
          <h1 className="text-2xl font-bold text-white">Ask a Good Question</h1>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-300">
                <strong className="font-semibold">Writing a great question:</strong> Include relevant code, error messages,
                and what you've already attempted. Specific questions get faster, better answers.
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              {showSimilar && (
                <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="mt-4">
                  ...
                  {SIMILAR_QUESTIONS.map((q) => (
                    <Link key={q} href="#" className="block text-xs text-blue-400 hover:underline py-0.5">→ {q}</Link>
                  ))}
                </motion.div>
              )}
            </CardContent>
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardContent className="p-5">
              ...
              <Textarea
                ...
                className="min-h-[240px] bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 font-mono text-sm"
              />
              <p className="mt-1.5 text-xs text-gray-600">{body.length} characters</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardContent className="p-5">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={addTag} variant="outline" className="border-gray-700 text-gray-300 shrink-0">
              ...
              {tags.length > 0 && (
                <div className="mt-2 flex flex-wrap gap-1.5">
                  {tags.map((tag) => (
                    <Badge
                      key={tag}
                      className="bg-gray-800 text-gray-300 cursor-pointer hover:bg-red-900 hover:text-red-300 transition-colors"
