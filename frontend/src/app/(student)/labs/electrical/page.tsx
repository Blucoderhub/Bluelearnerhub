    ...
    return (
        <div className="h-[90vh] flex flex-col gap-4 -mt-6">
            ...
            <div className="flex-1 flex gap-4 overflow-hidden">
                {/* Component Toolbox */}
                <div className="w-64 bg-background/40 border border-border rounded-xl flex flex-col overflow-hidden">
                    <div className="p-4 border-b border-border bg-slate-900/20">
                        <h3 className="text-[10px] font-black text-muted-foreground uppercase tracking-widest flex items-center justify-between">
                    ...
                    <div className="flex-1 p-3 space-y-2 overflow-y-auto">
                        {components.map(comp => (
                            <div
                                key={comp.name}
                                className="flex items-center gap-3 p-3 bg-card/60 border border-border rounded-xl cursor-grab active:cursor-grabbing hover:border-yellow-500/30 transition-all group"
                            >
                                ...
                                <div className="flex-1 overflow-hidden">
                                    <p className="text-[9px] font-black text-foreground/80 truncate uppercase leading-none">{comp.name}</p>
                                    <p className="text-[7px] text-muted-foreground font-bold uppercase mt-1">SMD_ACTIVE</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="flex-1 flex flex-col gap-4 overflow-hidden">
                    <div className="flex-1 bg-background/80 border border-border rounded-xl relative overflow-hidden group">
                        {/* Grid Pattern */}
                        <div className="absolute inset-0 bg-[radial-gradient(hsl(var(--secondary))_1px,transparent_1px)] [background-size:20px_20px] opacity-30" />

                        <div className="absolute top-4 right-4 flex gap-2 z-10">
                            <Badge className="bg-slate-900/90 text-muted-foreground border-border font-mono text-[9px] px-2 py-1">X: 124 Y: 88</Badge>
                        </div>
                        ...
                        <div className="absolute left-1/2 -translate-x-1/2 bottom-6 bg-slate-900/90 border border-border rounded-2xl p-1 flex items-center gap-1 backdrop-blur-xl shadow-2xl">
                            <Button size="icon" variant="ghost" className="h-10 w-10 text-muted-foreground hover:text-white hover:bg-secondary rounded-xl"><MousePointer2 className="w-4 h-4" /></Button>
                            <Button size="icon" variant="ghost" className="h-10 w-10 text-muted-foreground hover:text-white hover:bg-secondary rounded-xl"><Plus className="w-4 h-4" /></Button>
                            <Button size="icon" variant="ghost" className="h-10 w-10 text-muted-foreground hover:text-white hover:bg-secondary rounded-xl"><Activity className="w-4 h-4" /></Button>
                    ...
                    <div className="h-56 bg-background border border-border rounded-xl overflow-hidden flex flex-col shadow-2xl">
                        <div className="p-2 border-b border-border bg-slate-900/40 flex items-center justify-between">
                            <div className="flex items-center gap-2 ml-2">
                                <Waves className="w-3.5 h-3.5 text-yellow-500" />
                                <span className="text-[10px] font-black text-muted-foreground uppercase tracking-tighter">DIGITAL_OSCILLOSCOPE_CH1</span>
                            </div>
                            <div className="flex items-center gap-3 pr-2">
                                <div className="flex items-center gap-1.5">
                                    <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                    <span className="text-[9px] font-mono text-foreground/80">5.02V</span>
                                </div>
                                <div className="flex items-center gap-1.5">
                                    <div className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                                    <span className="text-[9px] font-mono text-primary/80">120 Hz</span>
                                </div>
                            </div>
                        </div>
                        <div className="flex-1 p-0 relative overflow-hidden flex">
                            ...
                            <div className="flex-1 flex items-center justify-center p-4">
                                <svg viewBox="0 0 600 100" className="w-full h-full overflow-visible">
                                    <motion.path
                                        ...
                                        className={`stroke-foreground/70 stroke-[2] fill-none drop-shadow-[0_0_8px_rgba(59,130,246,0.35)] transition-all ${isPowerOn ? 'opacity-100' : 'opacity-20'}`}
                                        animate={isPowerOn ? {
                                            d: [
                            ...
                            <div className="w-48 bg-card/60 border-l border-border p-4 space-y-4">
                                <div className="space-y-2">
                                    <p className="text-[8px] text-muted-foreground font-black uppercase tracking-widest">Timebase</p>
                                    <div className="flex gap-1">
                                        <Button size="icon" variant="outline" className="h-6 w-full text-[9px] font-black italic bg-background border-border">10ms</Button>
                                ...
                                <div className="space-y-1">
                                    <div className="flex justify-between text-[8px] text-muted-foreground font-black uppercase">
                                        <span>Trigger</span>
