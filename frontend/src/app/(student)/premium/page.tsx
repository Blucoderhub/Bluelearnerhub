    ...
    return (
        <div className="max-w-7xl mx-auto space-y-16 pb-32 animate-in fade-in duration-1000">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-500 font-bold uppercase text-[10px] tracking-widest max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-slate-900/40 border-slate-800 p-6 flex items-center justify-between group">
                    <div className="space-y-1">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">AI_Credits_Remaining</p>
                ...
                <Card className="bg-slate-900/40 border-slate-800 p-6 flex items-center justify-between group">
                    <div className="space-y-1">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Proof_Score_Boost</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {tiers.map((tier) => (
                    ...
                    >
                        <Card className={`flex-1 bg-slate-900/60 border-2 ${tier.border} relative overflow-hidden flex flex-col group`}>
                            {tier.popular && (
                            ...
                            <CardHeader className="space-y-4 p-8">
                                <div className={`p-4 w-16 h-16 rounded-2xl bg-slate-950 border border-slate-800 flex items-center justify-center ${tier.color} group-hover:scale-110 transition-transform duration-500`}>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex items-baseline gap-1">
                                        ...
                                        <span className="text-slate-500 font-bold text-xs">{tier.period}</span>
                                    </div>
                                </div>
                                <CardDescription className="text-xs text-slate-400 font-medium uppercase leading-relaxed">
                                    {tier.description}
                                </CardDescription>
                            </CardHeader>

                            <CardContent className="p-8 pt-0 space-y-4 flex-1">
                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] italic mb-6">Tier_Assets</p>
            ...
            {/* Security & FAQ Info */}
            <div className="p-12 bg-slate-900 border border-slate-800 rounded-3xl relative overflow-hidden group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
                    ...
                    <div className="flex flex-col justify-center items-center md:items-end gap-6">
                        ...
                        <p className="text-[10px] font-black text-slate-500 uppercase italic tracking-widest">Global_Payment_Protocols_Active</p>
                    </div>
                </div>
            </div>
        </div>
