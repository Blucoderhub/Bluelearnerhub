...
import {
  Map, Clock, Users, Star, ChevronRight,
  Code2, Settings, Zap, TrendingUp, BookOpen,
  DollarSign, Filter, Search, Award
} from 'lucide-react';
...
const TRACKS_FALLBACK = [
  {
    id: 1, slug: 'full-stack-engineer', title: 'Full-Stack Software Engineer',
    domain: 'Software', careerOutcome: 'Become a Full-Stack Engineer',
    estimatedWeeks: 24, difficulty: 'intermediate', enrollmentCount: 8420,
    rating: 4.9, courseCount: 8, icon: Code2,
    gradient: 'from-blue-600 to-purple-600',
    skills: ['React', 'Node.js', 'PostgreSQL', 'Docker', 'TypeScript'],
    description: 'Master the complete web development stack — from pixel-perfect UIs to scalable backend APIs.',
    hasCertificate: true,
  },
  {
    id: 2, slug: 'ml-engineer', title: 'Machine Learning Engineer',
    domain: 'AI/ML', careerOutcome: 'Become an ML Engineer',
    estimatedWeeks: 28, difficulty: 'advanced', enrollmentCount: 6200,
    rating: 4.8, courseCount: 10, icon: Zap,
  ...
  {
    id: 3, slug: 'mechanical-design-engineer', title: 'Mechanical Design Engineer',
  ...
  {
    id: 4, slug: 'investment-banking-analyst', title: 'Investment Banking Analyst',
  ...
  {
    id: 5, slug: 'data-analyst', title: 'Data Analyst',
    domain: 'Data', careerOutcome: 'Become a Data Analyst',
    estimatedWeeks: 14, difficulty: 'beginner', enrollmentCount: 9800,
    rating: 4.8, courseCount: 6, icon: BookOpen,
  ...
  {
    id: 6, slug: 'electrical-systems-engineer', title: 'Electrical Systems Engineer',
            ...
            {DOMAINS.map((d) => (
              <button
                ...
                className={`rounded-lg px-3 py-1.5 text-xs font-medium transition-colors ${
                  domain === d ? 'bg-purple-600 text-white' : 'bg-gray-800 text-gray-400 hover:text-white'
                }`}
              >
                {d}
              </button>
                  ...
                  <CardContent className="p-5 flex flex-col h-full relative">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge className={`text-xs ${DIFFICULTY_COLORS[track.difficulty as keyof typeof DIFFICULTY_COLORS]}`}>
                          {track.difficulty}
                        </Badge>
                    ...
                    <div className="mb-4 flex flex-wrap gap-1">
                      ...
                      {track.skills.length > 4 && (
                        <span className="text-[10px] text-gray-600">+{track.skills.length - 4}</span>
                      )}
                    </div>
