...
const CONTACT_CHANNELS = [
  { icon: Mail, label: 'Support Email', value: 'support@bluelearnerhub.com', href: 'mailto:support@bluelearnerhub.com' },
    ...
    <main className="mx-auto max-w-5xl px-6 py-24 text-foreground">
      <div className="mb-16 text-center">
        ...
        <p className="mx-auto max-w-xl text-lg text-muted-foreground">
          Have a question, partnership inquiry, or just want to say hello? We respond within 24 hours.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        <div className="space-y-8">
          ...
          {CONTACT_CHANNELS.map((c, i) => {
            const Icon = c.icon
            return (
              <div key={i} className="flex items-start gap-4 rounded-2xl border border-border/40 bg-card/40 p-6">
                ...
                <div>
                  ...
                  {c.href ? (
                    <a href={c.href} className="mt-1 text-sm font-medium text-white hover:text-primary transition-colors">
                      {c.value}
                    </a>
                  ) : (
          ...
          <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <a href="mailto:partnerships@bluelearnerhub.com" className="text-primary underline">
                partnerships@bluelearnerhub.com
              </a>
            </p>
          </div>
        </div>
          ...
          {done ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                  <label className="mb-1.5 block text-xs font-bold uppercase tracking-widest text-muted-foreground">Name</label>
                  <input
                ...
                <div>
                  <label className="mb-1.5 block text-xs font-bold uppercase tracking-widest text-muted-foreground">Email</label>
                  <input
              ...
              <div>
                <label className="mb-1.5 block text-xs font-bold uppercase tracking-widest text-muted-foreground">Subject</label>
                <select
              ...
              <div>
                <label className="mb-1.5 block text-xs font-bold uppercase tracking-widest text-muted-foreground">Message</label>
                <textarea
