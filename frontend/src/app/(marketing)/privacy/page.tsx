      ...
      <section className="prose prose-invert max-w-none space-y-10">
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            We collect information you provide directly to us (name, email, profile details), information generated
            through your use of the platform (quiz results, course progress, hackathon submissions), and standard
            technical data (IP address, browser type, cookies) to operate and improve the service.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            We use strictly necessary cookies (authentication tokens stored as HttpOnly cookies) and optional
            analytics cookies. You may disable optional cookies in your browser settings without affecting core
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            We do not sell your personal data. We share data only with service providers who process it on our
            behalf (hosting, email delivery, payment processing) and are bound by data processing agreements.
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Depending on your jurisdiction you have the right to access, correct, delete, and port your data.
            Contact us at{' '}
            <a href="mailto:privacy@bluelearnerhub.com" className="text-primary underline">
              privacy@bluelearnerhub.com
            </a>{' '}
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            or an in-app notification. Continued use of the platform after changes constitutes acceptance.
          </p>
        </div>
