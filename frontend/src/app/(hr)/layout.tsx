        ...
        <div className="flex min-h-screen bg-[#020617] text-white overflow-hidden">
            <aside className="hidden md:flex w-72 flex-col border-r border-slate-800 bg-slate-900/50 backdrop-blur-xl sticky top-0 h-screen z-40">
                <div className="flex h-16 items-center border-b border-slate-800 px-8">
                    <h2 className="text-xl font-bold tracking-tight text-cyan-400">HR Portal</h2>
                </div>

                <div className="flex-1 overflow-y-auto py-6 px-4 space-y-8">
                    <div className="space-y-1.5">
                        <p className="px-4 text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Recruitment Hub</p>
                        {hrNav.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    {isActive && (
                                        <span className="absolute left-0 w-1 h-6 bg-cyan-500 rounded-r-full" />
                                    )}
