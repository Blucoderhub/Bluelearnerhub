        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.map((stat, index) => (
                    ...
                    >
                        <Card className="bg-slate-900/40 border-border hover:border-cyan-500/30 transition-all group">
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    <span className="text-foreground/70 text-xs font-medium">+14% </span>
                                    from last month
                                </p>
                            </CardContent>
                        </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <CardContent className="p-6">
                            <div className="relative mb-6">
                                ...
                                <Input
                                    ...
                                    className="pl-10 bg-background/50 border-border text-white placeholder:text-muted-foreground focus:ring-cyan-500/50"
                                />
                            </div>

                            <div className="space-y-4">
                                {[1, 2, 3].map((candidate) => (
                                    <div key={candidate} className="flex items-center justify-between p-4 rounded-xl bg-background/30 border border-slate-800/50 hover:border-cyan-500/20 transition-all cursor-pointer group">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-cyan-400 font-bold border border-border">
                                                C
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-white text-sm">Top Candidate {candidate}</h4>
                                                <p className="text-xs text-muted-foreground">Full-Stack Engineer • Level 8</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                ...
                <div className="space-y-6">
                    <Card className="bg-background/40 border-border border-t-2 border-t-cyan-500">
                        <CardHeader>
                            <CardTitle className="text-base font-bold">Upcoming Interviews</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            {[1, 2].map((interview) => (
                                <div key={interview} className="p-3 rounded-lg bg-card/50 border border-border">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">Candidate: Shankar R.</p>
                                </div>
                            ))}
                    ...
                    <Card className="bg-gradient-to-br from-cyan-900/20 to-background/40 border-border relative overflow-hidden group">
