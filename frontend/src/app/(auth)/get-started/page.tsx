...
export default function GetStartedPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-background px-4 py-4 text-foreground overflow-hidden">
      ...
      >
        <div className="space-y-2 text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="space-y-1">
              ...
              <p className="max-w-md mx-auto font-serif text-sm text-muted-foreground">
                Join the hub
              </p>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/40 p-1 shadow-3xl backdrop-blur-2xl">
