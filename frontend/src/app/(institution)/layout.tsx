        ...
        <div className="flex h-20 items-center justify-between border-b border-border/40 px-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-sm font-bold uppercase tracking-tight text-foreground">
              Institution <span className="opacity-70">HQ</span>
            </h2>
          </div>
          <button
        ...
        <div className="border-t border-border/40 bg-muted/10 p-6">
          <div className="flex items-center gap-4">
            <Avatar className="h-10 w-10 border border-border/40">
              <AvatarImage src="" />
              <AvatarFallback className="bg-muted font-bold text-foreground">IN</AvatarFallback>
            </Avatar>
            <div className="min-w-0 flex-1">
              <p className="truncate text-xs font-bold text-foreground">Institution Admin</p>
              <p className="truncate text-[10px] text-muted-foreground">Academic Governance</p>
            </div>
            <Button
              variant="ghost"
              size="icon"
