            ...
            <aside className={cn(
                ...
                <div className="flex h-20 items-center justify-between border-b border-border px-8">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-sm font-black tracking-tight text-white uppercase">
                            Institution <span className="text-foreground/70">HQ</span>
                        </h2>
                    </div>
                    <button
                ...
                <div className="flex-1 overflow-y-auto py-8 px-4 space-y-10">
                    <div className="space-y-2">
                        <p className="px-4 text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] mb-6">Command Center</p>
                        {institutionNav.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {isActive && (
                                        <ChevronRight className="w-3 h-3 text-foreground/70 animate-pulse" />
                                    )}
                                </Link>
                            )
                        })}
                    ...
                    <div className="px-4">
                        <div className="p-5 rounded-2xl bg-card/50 border border-border relative overflow-hidden">
                            ...
                            <p className="text-[10px] text-muted-foreground font-medium mt-2">All departments compliant</p>
                            <Link href="/analytics" className="inline-block text-[10px] font-bold text-foreground/70 mt-4 hover:underline">
                                View Report →
                            </Link>
                        </div>
                    </div>
                ...
                <div className="p-6 border-t border-border bg-background/20">
                    <div className="flex items-center gap-4">
                        <Avatar className="h-10 w-10 border border-border">
                            <AvatarImage src="" />
                            <AvatarFallback className="bg-primary/20 text-foreground/70 font-bold">IN</AvatarFallback>
                        </Avatar>
                        <div className="flex-1 min-w-0">
                            <p className="text-xs font-bold text-white truncate">Institution Admin</p>
                            <p className="text-[10px] text-muted-foreground truncate">Academic Governance</p>
                        </div>
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-y-auto bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-background/20 via-background to-background">
                <header className="h-16 md:h-20 border-b border-border flex items-center justify-between px-4 md:px-8 bg-background/50 backdrop-blur-xl sticky top-0 z-30">
                    <div className="flex items-center gap-4">
                        ...
                        <Search className="w-4 h-4 text-muted-foreground hover:text-foreground/70 transition-colors cursor-pointer" />
                        <div className="hidden md:block h-4 w-[1px] bg-secondary" />
                        <span className="hidden md:inline-flex items-center px-2.5 py-0.5 rounded-full bg-primary/10 text-foreground/70 text-[10px] font-bold">All Systems Operational</span>
                    </div>
