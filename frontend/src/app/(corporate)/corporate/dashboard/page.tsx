    ...
    <div className="space-y-8 pb-20 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, i) => (
          ...
          >
            <Card className="bg-slate-900/40 border-slate-800 hover:bg-slate-900/60 transition-all group overflow-hidden relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-slate-950/40 border-slate-800 p-8 h-[400px] flex flex-col relative overflow-hidden group/chart">
            <div className="flex-1 flex items-end justify-between gap-4">
              ...
              {[
                ...
                <div key={bar.d} className="flex-1 flex flex-col items-center gap-3">
                  ...
                  >
                    <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] font-black px-2 py-1 rounded opacity-0 group-hover/bar:opacity-100 transition-opacity">
                      {bar.v}
                    </div>
                  </motion.div>
                  <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">{bar.d}</span>
                </div>
              ))}
            </div>
            <div className="absolute top-8 right-8 flex flex-col gap-2">
              <Badge variant="outline" className="bg-slate-900 border-slate-800 text-[9px] font-black uppercase text-slate-400">Monthly Growth: +12.4%</Badge>
            </div>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-slate-900 border-primary/20 p-6 space-y-4 relative overflow-hidden group">
            ...
            <div className="space-y-3 pt-2">
              <div className="p-3 bg-slate-950 border border-slate-800 rounded-xl flex items-center gap-3 hover:border-primary/20 transition-all cursor-pointer">
                <Target className="w-4 h-4 text-primary" />
                <div>
                  <p className="text-[10px] font-black text-white uppercase leading-none italic">Top Domain</p>
                  <p className="text-[8px] text-slate-500 font-bold uppercase mt-1">Robotics & Control Systems</p>
                </div>
              </div>
              <div className="p-3 bg-slate-950 border border-slate-800 rounded-xl flex items-center gap-3 hover:border-primary/20 transition-all cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-[8px] text-slate-500 font-bold uppercase mt-1">IIT Madras - Mech Dept</p>
                </div>
              </div>
            </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <Card key={talent.name} className="bg-slate-900 border-slate-800 hover:bg-slate-900/40 transition-all group overflow-hidden">
              <CardHeader>
              ...
              <CardFooter className="pt-0 flex gap-2">
                <Button variant="ghost" className="flex-1 h-9 text-[10px] font-black uppercase text-slate-400 hover:text-white border border-slate-800">VIEW_PROFILE</Button>
