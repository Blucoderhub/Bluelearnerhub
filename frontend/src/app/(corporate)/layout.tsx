            ...
            <aside className={cn(
                ...
                <div className="flex-1 overflow-y-auto py-8 px-4 space-y-10">
                    ...
                    <div className="space-y-2">
                        <p className="px-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-6">Operations Center</p>
                    ...
                    <div className="px-4">
                        <div className="p-5 rounded-2xl bg-slate-900/50 border border-slate-800 relative overflow-hidden group">
                            <div className="absolute top-0 left-0 w-1 h-full bg-primary" />
                            <h4 className="text-[10px] font-black italic text-white uppercase tracking-widest">Active Recruiting</h4>
                            <p className="text-[10px] text-slate-500 font-bold uppercase mt-2">3 New Matches Found</p>
                ...
                <div className="p-6 border-t border-slate-800/60 bg-slate-950/20">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[10px] text-slate-500 font-bold uppercase truncate">Level 5 Enterprise</p>
                        </div>
                ...
                <header className="h-16 md:h-20 border-b border-slate-800/40 flex items-center justify-between px-4 md:px-8 bg-[#020617]/50 backdrop-blur-xl sticky top-0 z-30">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="relative cursor-pointer group">
                            ...
                            <span className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 border-2 border-[#020617] rounded-full animate-bounce" />
                        </div>
                        <div className="flex items-center gap-3 bg-slate-900/50 px-4 py-2 rounded-xl border border-slate-800">
                            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Org_Credit:</span>
