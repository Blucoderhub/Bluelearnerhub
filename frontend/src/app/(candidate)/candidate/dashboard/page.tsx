        ...
        <div className="space-y-8 pb-20 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.map((stat, index) => (
                    ...
                    >
                        <Card className="bg-slate-900/40 border-slate-800 hover:border-blue-500/30 transition-all group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <CardContent className="p-0">
                            <div className="divide-y divide-slate-800/50">
                                {applications.map((app, i) => (
                                    <div key={i} className="flex items-center justify-between p-5 hover:bg-slate-900/30 transition-all cursor-pointer group">
                                ...
                                {[
                                    ...
                                    <div key={i} className="flex items-center justify-between">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span className="text-[10px] text-slate-500 ml-2">{item.period}</span>
                                        </div>
                                    </div>
                                ))}
                            </CardContent>
                ...
                <div className="space-y-6">
                    <Card className="bg-slate-950/40 border-slate-800 border-t-2 border-t-purple-500">
                        <CardHeader>
                            <CardTitle className="text-base font-bold flex items-center gap-2">
                        ...
                        <CardContent className="space-y-4">
                            {interviews.map((interview, i) => (
                                <div key={i} className="p-4 rounded-xl bg-slate-900/50 border border-slate-800 space-y-2">
                                    ...
                                    <Badge className="bg-slate-800 text-slate-300 text-[10px] border-none">{interview.type}</Badge>
                                </div>
                            ))}
                    ...
                    <Card className="bg-gradient-to-br from-blue-900/20 to-slate-950/40 border-slate-800 relative overflow-hidden group">
                        <div className="relative z-10 p-6">
                            <Zap className="w-8 h-8 text-blue-500/50 mb-3 group-hover:scale-110 transition-transform" />
                            ...
                            <Button size="sm" className="bg-blue-600 hover:bg-blue-500 text-white text-xs px-6 py-4 h-auto font-bold shadow-lg shadow-blue-900/50">
                                Start Practice
                            </Button>
                        </div>
