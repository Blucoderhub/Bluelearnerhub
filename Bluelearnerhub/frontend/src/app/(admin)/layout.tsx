...
export default function AdminLayout({
    ...
    return (
        <div className="flex min-h-screen bg-[#020617] text-slate-200 overflow-hidden font-mono text-sm uppercase tracking-tighter">
            {/* Sidebar - Root Admin Design */}
            <aside className="hidden md:flex w-72 flex-col border-r border-[#1e293b] bg-[#020617] sticky top-0 h-screen z-40">
                <div className="flex h-20 items-center border-b border-[#1e293b] px-8">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
                {/* Superior Barra */}
                <header className="h-20 border-b border-[#1e293b] flex items-center justify-between px-8 bg-[#020617]/50 backdrop-blur-xl sticky top-0 z-30">
                ...
                <main className="p-8 md:p-12 lg:p-16 max-w-[1700px] mx-auto w-full relative">
